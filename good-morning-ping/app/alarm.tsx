...
export default function ProofOfLifeAlarm() {
  ...
  // Animation value for the pulsing ring
  ...
  const handleMathFallback = () => {
    Alert.prompt("Solaris Protocol", "What is 8 x 7?", [
      {
        text: 'Submit',
        onPress: (text) => {
        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.topSection}>
            ...
            <BlurView intensity={20} tint="dark" style={styles.timerCard}>
              ...
              <Text style={styles.timerValue}>04:12</Text>
            </BlurView>
          </View>
...
const styles = StyleSheet.create({
  ...
  heroText: {
    ...
    letterSpacing: 1,
    marginBottom: 40,
    textShadowColor: 'rgba(255, 181, 157, 0.4)',
    textShadowOffset: { width: 0, height: 0 },
    textShadowRadius: 20,
    textAlign: 'center',
  },
  timerCard: {
    backgroundColor: 'rgba(22, 23, 61, 0.6)', // surface-container-low
    borderRadius: 32,
    padding: 32,
  ...
  timerLabel: {
    color: '#c8c5cf', // on-surface-variant
    fontSize: 12,
    fontWeight: '600',
    marginBottom: 8,
    letterSpacing: 1,
